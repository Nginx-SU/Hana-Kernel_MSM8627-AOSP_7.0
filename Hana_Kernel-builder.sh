...
java -jar signapk.jar signature-key.Nicklas@XDA.x509.pem signature-key.Nicklas@XDA.pk8 Hana_Kernel_v1.0-nicki.zip Hana_Kernel_v1.2-RC4-nicki-signed.zip
rm Hana_Kernel_v1.0-nicki.zip
mv Hana_Kernel_v1.2-RC4-nicki-signed.zip /home/nicklas
echo "###Complete..."
