...
rm -rvf Hana_output
rm -rvf Hana_output
echo "###Sign Hana Core UX..."
mv Hana_Core-UX_v1.2.5-nicki.zip Hana_CoreUX-EXT/Hana_Signer/Hana_Core-UX_v1.2.5-nicki.zip
cd Hana_CoreUX-EXT/Hana_Signer
java -jar signapk.jar signature-key.Nicklas@XDA.x509.pem signature-key.Nicklas@XDA.pk8 Hana_Core-UX_v1.2.5-nicki.zip Hana_Core-UX_v1.2.7-nicki-signed.zip
rm Hana_Core-UX_v1.2.5-nicki.zip
mv Hana_Core-UX_v1.2.7-nicki-signed.zip /home/nicklas
echo "###Complete..."
