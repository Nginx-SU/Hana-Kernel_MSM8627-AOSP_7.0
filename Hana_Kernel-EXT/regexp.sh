...
echo "###Running second regexp init"

find arch/ -name "*.h" | xargs sed -i "s/ __cpuinit//g"

echo "##Done"

echo "###Running third regexp init"

find -name "*.c" | xargs sed -i "s/ __cpuinit$//g"

echo "##Done"

echo "###Running fourth regexp init"

find -name "*.c" | xargs sed -i "s/ __cpuinitdata//g"

echo "##Done"

echo "###Running fifth regexp init"

find -name "*.c" | xargs sed -i "s/ __cpuexit / /g"

echo "##Done"

echo "###Running sixth regexp init"
